...
*この2時間のワークショップでは、「プラグを抜いた」クリエイティブコーディングを探求します。つまり、コンピューターを使わずにアルゴリズムアートの原理と、計算思考 (IRL) を試します。 共同のドローイング、人間によるフロッキング、ルールベースの言葉遊びからなるこれらの演習は、優れたアイスブレイクになります。*
...
1. 整列: 後方に移動しないようにします。 （安全ではありません！）
2. 反発: 腕の長さよりも近くにいる人から離れます。
3. 結合： 常に「N」人の隣人を腕の長さで保ちます。 (N=2 がうまくいきます。)
...
ZSPはルールベースの単語ゲームで、理想的には5人が円になって座ってプレイします。いつでも、5人のプレイヤーのうち2人が「アクティブな会話」を行っています。 テーブルにいる全員が、現在アクティブな会話をしている2人のプレーヤーを追跡する必要があります。 これは、コンピュータープログラムの状態をトレースするのとよく似ています。さまざまな特別な言葉や行動が、「アクティブな会話」を行なっている人同士の組み合わせを変更します。ZSPは飲み会ゲームとしてプレイされることもあります(つまり、失敗したときに飲みます)。
...
* **ズーム**は「お話しましょう！」、「こんにちは、あなたとお話したいです」という意味です。 ズーム は新しい人との会話を*開始します*。 いつでも ズーム と言うことができますが、既に会話している相手に ズーム することはできません。
* **シュワルツ** は「OK!」または「私たちが会話中であることを認識し、あなたにお返事します」という意味です。 あなたは既に シュワルツ してきた誰かと会話をしていることになります。
* **プロフィグリアーノ** は「その人を見てください！」という意味です。または「ねえ、その人について話しましょう。」 プロフィグリアーノ のスピーカーは、「アクティブな会話」をしている相手ではない第三者に目を向ける必要があります。PROFIGLIANO は、現在の会話に参加している人同士の組を変更しません。
...
* 既に会話をしている相手を ズーム した場合
* まだ会話をしていない人を シュワルツ した場合
* あなたがすでに会話をしている相手に プロフィグリアーノ した場合
...
* **ボインク**: シュワルツ とまったく同じですが、膝を見てまばたきをする必要があります。
* **ベルヴィデーレ**: これはあなたの左側の人への ズーム です。 両手を上げてベルヴィデーレを空に向けて叫ばなければなりません。
* **ミプミプ**は「さようなら」という意味です。 これにより、アクティブな会話から離れることができます。 あなたが話していた人は、別の誰かを ズーム （または ベルヴィデーレ ）する義務があります。
* **クワッフル** は「今何が起こったの？」という意味です。 クワッフル　されたプレーヤーは、　クワッフル　の直前に使用された単語を繰り返す必要があります。 クワッフル には「暗黙の ズーム 機能」があります。 つまり、クワッフルされたプレイヤー (まだアクティブな会話に参加していない場合) も効果的に ズーム されています。
* *他にもたくさんあります！*
